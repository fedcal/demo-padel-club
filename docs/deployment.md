...
URL: `https://padel-club.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `padel-club.demo.federicocalo.dev`
...
- Output directory: `dist/padel-club/browser`
...
Per usare `padel-club-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   padel-club-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `padel-club-docs.federicocalo.dev`
